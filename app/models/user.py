...
class User(UserMixin):
    def __init__(self, id, email, password, firstname, lastname, address, balance, isSeller):
        self.id = id
        self.email = email
    ...
    def get_by_auth(email, password):
        rows = app.db.execute("""
SELECT password, id, email, password, firstname, lastname, address, balance, isSeller
FROM Users
WHERE email = :email
""",
                              email=email)
...
""",
    ...
    def get(id):
        rows = app.db.execute("""
SELECT id, email, password, firstname, lastname, address, balance, isSeller
FROM Users
WHERE id = :id
""",
                              id=id)
